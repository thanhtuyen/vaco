...
CREATE TABLE IF NOT EXISTS `mydb`.`Menu` (
  ...
  CONSTRAINT `fk_Menu_Menu`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Menu_detailmenu1`
    FOREIGN KEY (`detailmenu_id`)
    REFERENCES `mydb`.`detailmenu` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
